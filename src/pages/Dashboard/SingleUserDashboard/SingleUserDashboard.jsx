        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            {user.role === "admin" && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-4 bg-blue-100 rounded shadow">Total Users: {stats.totalUsers}</div>
                    <div className="p-4 bg-blue-100 rounded shadow">Total Sellers: {stats.totalSellers}</div>
                    <div className="p-4 bg-blue-100 rounded shadow">Total Buyers: {stats.totalBuyers}</div>
                </div>
            )}
